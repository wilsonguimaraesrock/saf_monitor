        ...
        <div className="w-full max-w-sm">
          <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-800 p-8">
            ...
            <div className="text-center mb-7">
              ...
              <h2 className="text-lg font-bold text-gray-900 dark:text-slate-100">Acesso ao sistema</h2>
              <p className="text-xs text-gray-400 dark:text-slate-500 mt-1">Entre com suas credenciais</p>
            </div>
